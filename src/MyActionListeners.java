...
public class MyActionListeners {
	...
	public static ActionListener createSaveMovieChangesListener(final InfoPanel infoPanel){
		...
		return new ActionListener() {
			...
			@Override public void actionPerformed(ActionEvent arg0){
				infoPanel.saveMovieInformation();
			}
		};
	}
		...
		return new FocusListener() {
			@SuppressWarnings("unchecked") @Override public void focusLost(FocusEvent e){
				...
				if (field.getText().equals("")) {
					...
					((TableRowSorter<MovieTable>) mainFrame.getMovieTable().getRowSorter()).setRowFilter(null); //reset the row sorter to show all rows
				}
			}
	...
	public static KeyListener createUpdateCurrntMovieKeyListener(){
		// TODO Auto-generated method stub
